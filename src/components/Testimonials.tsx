          ...
          {testimonials.map((t, i) => (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs font-semibold text-primary-500 bg-primary-50 px-2.5 py-1 rounded-full font-[family-name:var(--font-body)]">
                  {t.tag}
                </span>
              </div>
              <p className="text-neutral-700 text-sm leading-relaxed mb-4 font-[family-name:var(--font-body)]">
                &ldquo;{t.text}&rdquo;
              </p>
              <div>
